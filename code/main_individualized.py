...
if __name__ == '__main__':
    with open("../data/individualized/trainX_mnist_individualized", "rb") as fp:
        trainX = pickle.load(fp)
    with open("../data/individualized/trainY_mnist_individualized", "rb") as fp:
        trainY = pickle.load(fp)
    with open("../data/individualized/testX_mnist_individualized", "rb") as fp:
        testX = pickle.load(fp)
    with open("../data/individualized/testY_mnist_individualized", "rb") as fp:
    ...
    logh = open("../results/table6_real_individualized_res.txt", "w")
    sys.stdout = logh
